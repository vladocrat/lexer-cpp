...
import error.ParserInitializationException
import parser.*
 ...
 */
fun <T> OrdinaryParser<T>.many(atLeast: Int, atMost: Int = Int.MAX_VALUE): OrdinaryParser<List<T>> {
 ...
 * Otherwise, puts all results into a list and returns it.
 */
fun <T> SkipParser<T>.many(atLeast: Int, atMost: Int = Int.MAX_VALUE): SkipParser<List<T>> {
